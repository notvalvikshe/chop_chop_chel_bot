...
export class UserService {
  ...
  public async getUserByTelegramUser({
    id,
    first_name,
    last_name,
    username,
  }: TelegramUser): Promise<User> {
  ...
  public async getUserByIds(
    ids: number[],
    options?: { resultType: ResultType.Array },
  ): Promise<User[]>;
  public async getUserByIds(
    ids: number[],
    options?: { resultType: ResultType.Dictionary },
   ...
   */
  public async getUserWithBookings(
    userId: number,
   ...
   */
  public async getUserBookingsByTelegramId(
    telegramId: number,
